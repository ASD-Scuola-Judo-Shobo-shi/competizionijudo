        ...
        <tbody>
            <?php foreach ($clubs as $club) : ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm green" href="<?= e(app_path('/admin_edit_club.php?id=' . (int) $club->id)) ?>"><?= e(__('admin.clubs.edit')) ?></a>
                        <form method="post" action="<?= e(app_path('/admin_delete_club.php')) ?>" style="display:inline" onsubmit="return confirm('<?= e(__('admin.clubs.confirm_delete')) ?>')">
                            <?= csrf_field() ?>
