...
/* Note: $canViewEntries is kept for template compatibility but entry links are now always visible */
?>
<?php
...
<div class="card event-details-card">
    <div class="event-details-layout">
        ...
        <div class="event-details-info">
            <?php if ($event->closed) : ?>
                <span style="display: inline-block; background: #6c757d; color: white; padding: 4px 8px; border-radius: 4px; font-size: 0.75rem; font-weight: bold; margin-bottom: 8px;"><?= e(__('admin.dashboard.closed')) ?></span>
            <?php endif; ?>
